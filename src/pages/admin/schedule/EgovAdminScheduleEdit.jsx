        ...
        <div className="layout">
          ...
          <div className="contents SITE_SCHDULE_REG" id="contents">
            ...
            <div className="board_view2">
              ...
              <dl>
                <dt>
                  <label htmlFor="schdulDeptName">부서</label>
                ...
                <dd>
                  <input
                    ...
                    title="부서"
                    id="schdulDeptName"
                    value={scheduleDetail.schdulDeptName}
                    readOnly
                  />
                </dd>
              </dl>
              ...
              <dl>
                <dt>
                  <label htmlFor="schdulCn">일정내용</label>
                  <span className="req">필수</span>
                </dt>
                <dd>
                  <textarea
              ...
              <dl>
                <dt>
                  반복구분<span className="req">필수</span>
                </dt>
                <dd>
              ...
              <dl>
                <dt>
                  날짜/시간<span className="req">필수</span>
                </dt>
                <dd className="datetime">
                  <span className="line_break">
                    <DatePicker
                      ...
                      onChange={(date) => {
                        ...
                        setScheduleDetail({
                          ...
                          schdulBgndeHH: date.getHours(),
                          schdulBgndeMM: date.getMinutes(),
                          startDate: date,
                        });
                    ...
                    <input
                      type="hidden"
                      name="schdulBgndeHH"
                      defaultValue={schdulBgndeHH}
                      readOnly
                    />
                    <input
                      type="hidden"
                      name="schdulBgndeMM"
                      defaultValue={schdulBgndeMM}
                      readOnly
                    />
                  ...
                  <span className="line_break">
                    <DatePicker
                      ...
                      onChange={(date) => {
                        ...
                        setScheduleDetail({
                          ...
                          schdulEnddeHH: date.getHours(),
                          schdulEnddeMM: date.getMinutes(),
                          endDate: date,
                        });
                    ...
                    <input
                      type="hidden"
                      name="schdulEnddeHH"
                      defaultValue={schdulEnddeHH}
                      readOnly
                    />
                    <input
                      type="hidden"
                      name="schdulEnddeMM"
                      defaultValue={schdulEnddeMM}
                      readOnly
                    />
                  </span>
                </dd>
